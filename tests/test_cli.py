...
@pytest.mark.parametrize(
    ...
    [
        (
            ["--target", "foo"],
            {},
            [pretend.call("foo", None, "http", None, False)],
        ...
        (
            ...
            {},
            [pretend.call("foo", "/path/to/source.py", "http", None, False)],
            [pretend.call("0.0.0.0", 8080)],
        ),
        (
            [],
        ...
        (
            ...
            {},
            [pretend.call("foo", None, "event", None, False)],
            [pretend.call("0.0.0.0", 8080)],
        ),
        (
            [],
        ...
        (
            ["--target", "foo", "--debug"],
            {},
            [pretend.call("foo", None, "http", None, True)],
            [pretend.call("0.0.0.0", 8080)],
        ),
        (
            [],
